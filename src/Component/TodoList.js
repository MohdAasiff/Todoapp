...
const TodoList = () => {
  ...
  // Fetch data by calling function 
  useEffect(() => {
   ...
   //add in localstorage
  useEffect(() => {
    // Save todos to local storage whenever the app state changes
      ...
      <div className="todo-app">
        ...
        <ul id="list">
          {filteredTasks.length===0?(
            <li className="no-task">No tasks in the list</li>
